...
{
    public class IPQ04DataGetter : Prolink.WebReport.Business.IDataGetter
    {
        ...
        public DataSet GetDataSet(NameValueCollection nameValues)
        {
            ...
            */
            ...
            DataTable dt = ModelFactory.InquiryData("V_IPQ04.*", "V_IPQ04", condition, nameValues, ref recordsCount, ref pageIndex, ref pageSize);
