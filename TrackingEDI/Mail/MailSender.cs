        ...
        public bool Send(string subject, string receiver, string copyReceiver, string body, Attachment[] attachs)
        {
            using (MailMessage msg = new MailMessage())
            {
                ...
                if (!string.IsNullOrEmpty(receiver))
                {
                    ...
                    string[] toList = receiver.Split(new string[] { ";", "；" }, StringSplitOptions.RemoveEmptyEntries);
                    foreach (string to in toList)
                        msg.To.Add(to);
                }

                //if (copyReceiver != null && msg.CC != null && !string.IsNullOrEmpty(copyReceiver.Trim()))
                //    msg.CC.Add(copyReceiver.Replace(";", ","));
                if (copyReceiver != null && msg.CC != null && !string.IsNullOrEmpty(copyReceiver.Trim()))
                {
                    string[] toList = copyReceiver.Split(new string[] { ";", "；" }, StringSplitOptions.RemoveEmptyEntries);
