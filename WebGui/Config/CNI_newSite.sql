...
('RQD_NO',1,'20151214','CMP','公司',2,'CNI','CNI','*','TPV'),
('RQD_NO',2,'20151214','CONST','常量',1,'A','CNI','*','TPV'),
('RQD_NO',3,'20151214','YY','年度',2,'YY','CNI','*','TPV'),
('RQD_NO',4,'20151214','MM','月份',2,'MM','CNI','*','TPV'),
('RQD_NO',5,'20151214','NO','流水號',6,NULL,'CNI','*','TPV');
INSERT INTO SCS_AUTONO_RULE (RULE_CODE, RULE_NAME, EFFECT_DATE, CMP, STN, GROUP_ID) VALUES ('RQD_NO', '询价自动编号', '20151214', 'CNI', '*', 'TPV')
...
INSERT INTO SCS_AUTONO_ITEM (RULE_CODE, SEQ_NO, EFFECT_DATE, CODE, CODE_NAME, CODE_LEN, CODE_CONTENT, CMP, STN, GROUP_ID) VALUES
('QUOT_NO',1,'20160101','CMP','公司',2,'CNI','CNI','*','TPV'),
('QUOT_NO',2,'20160101','CONST','常量',1,'Q','CNI','*','TPV'),
('QUOT_NO',3,'20160101','YY','年度',2,'YY','CNI','*','TPV'),
('QUOT_NO',4,'20160101','MM','月份',2,'MM','CNI','*','TPV'),
('QUOT_NO',5,'20160101','NO','流水號',6,NULL,'CNI','*','TPV');
INSERT INTO SCS_AUTONO_RULE (RULE_CODE, RULE_NAME, EFFECT_DATE, CMP, STN, GROUP_ID) VALUES ('QUOT_NO', '询价自动编号', '20160101', 'CNI', '*', 'TPV')
...
INSERT INTO SCS_AUTONO_ITEM (RULE_CODE, SEQ_NO, EFFECT_DATE, CODE, CODE_NAME, CODE_LEN, CODE_CONTENT, CMP, STN, GROUP_ID) VALUES
('BAT_NO',1,'20160101','CMP','公司',2,'CNI','CNI','*','TPV'),
('BAT_NO',2,'20160101','CONST','常量',2,'LT','CNI','*','TPV'),
('BAT_NO',3,'20160101','YY','年度',2,'YY','CNI','*','TPV'),
('BAT_NO',4,'20160101','MM','月份',2,'MM','CNI','*','TPV'),
('BAT_NO',5,'20160101','NO','流水號',6,NULL,'CNI','*','TPV');
INSERT INTO SCS_AUTONO_RULE (RULE_CODE, RULE_NAME, EFFECT_DATE, CMP, STN, GROUP_ID) VALUES ('BAT_NO', '預約批次號', '20160101', 'CNI', '*', 'TPV')
...
INSERT INTO SCS_AUTONO_ITEM (RULE_CODE, SEQ_NO, EFFECT_DATE, CODE, CODE_NAME, CODE_LEN, CODE_CONTENT, CMP, STN, GROUP_ID) VALUES
('TK_NO',1,'20160101','CMP','公司',2,'CNI','CNI','*','TPV'),
('TK_NO',2,'20160101','CONST','常量',2,'ET','CNI','*','TPV'),
('TK_NO',3,'20160101','YY','年度',2,'YY','CNI','*','TPV'),
('TK_NO',4,'20160101','MM','月份',2,'MM','CNI','*','TPV'),
('TK_NO',5,'20160101','NO','流水號',6,NULL,'CNI','*','TPV');
INSERT INTO SCS_AUTONO_RULE (RULE_CODE, RULE_NAME, EFFECT_DATE, CMP, STN, GROUP_ID) VALUES ('TK_NO', '預約批次號', '20160101', 'CNI', '*', 'TPV')
...
INSERT INTO SCS_AUTONO_ITEM (RULE_CODE, SEQ_NO, EFFECT_DATE, CODE, CODE_NAME, CODE_LEN, CODE_CONTENT, CMP, STN, GROUP_ID) VALUES
('RV_NO',1,'20160101','CMP','公司',2,'CNI','CNI','*','TPV'),
('RV_NO',2,'20160101','CONST','常量',2,'R','CNI','*','TPV'),
('RV_NO',3,'20160101','YY','年度',2,'YY','CNI','*','TPV'),
('RV_NO',4,'20160101','MM','月份',2,'MM','CNI','*','TPV'),
('RV_NO',5,'20160101','NO','流水號',6,NULL,'CNI','*','TPV');
INSERT INTO SCS_AUTONO_RULE (RULE_CODE, RULE_NAME, EFFECT_DATE, CMP, STN, GROUP_ID) VALUES ('RV_NO', '預約批次號', '20160101', 'CNI', '*', 'TPV')
...
INSERT INTO SCS_AUTONO_ITEM (RULE_CODE, SEQ_NO, EFFECT_DATE, CODE, CODE_NAME, CODE_LEN, CODE_CONTENT, CMP, STN, GROUP_ID) VALUES
('SMRV_NO',1,'20160101','CMP','公司',2,'CNI','CNI','*','TPV'),
('SMRV_NO',2,'20160101','CONST','常量',2,'B','CNI','*','TPV'),
('SMRV_NO',3,'20160101','YY','年度',2,'YY','CNI','*','TPV'),
('SMRV_NO',4,'20160101','MM','月份',2,'MM','CNI','*','TPV'),
('SMRV_NO',5,'20160101','NO','流水號',6,NULL,'CNI','*','TPV');
INSERT INTO SCS_AUTONO_RULE (RULE_CODE, RULE_NAME, EFFECT_DATE, CMP, STN, GROUP_ID) VALUES ('SMRV_NO', '預約批次號', '20160101', 'CNI', '*', 'TPV')
...
INSERT INTO SCS_AUTONO_ITEM (RULE_CODE, SEQ_NO, EFFECT_DATE, CODE, CODE_NAME, CODE_LEN, CODE_CONTENT, CMP, STN, GROUP_ID) VALUES
('ORD_NO',1,'20160101','CMP','公司',3,'CNI','CNI','*','TPV'),
('ORD_NO',2,'20160101','CONST','常量',2,'O','CNI','*','TPV'),
('ORD_NO',3,'20160101','YY','年度',2,'YY','CNI','*','TPV'),
('ORD_NO',4,'20160101','MM','月份',2,'MM','CNI','*','TPV'),
('ORD_NO',5,'20160101','NO','流水號',6,NULL,'CNI','*','TPV');
