...
{
    public class IPQ01DataGetter : Prolink.WebReport.Business.IDataGetter
    {
        ...
        public DataSet GetDataSet(NameValueCollection nameValues)
        {
            ...
            */
            ...
            DataTable dt = ModelFactory.InquiryData("V_IPQ01.*", "V_IPQ01", condition, nameValues, ref recordsCount, ref pageIndex, ref pageSize);
