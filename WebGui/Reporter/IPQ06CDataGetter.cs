...
{
    public class IPQ06CDataGetter : Prolink.WebReport.Business.IDataGetter
    {
        ...
        public DataSet GetDataSet(NameValueCollection nameValues)
        {
            ...
            DataTable dt = ModelFactory.InquiryData("V_IPQ06.*", "V_IPQ06", condition, nameValues, ref recordsCount, ref pageIndex, ref pageSize);
            ...
            string sql = "SELECT CNTR_NO, SEAL_NO1, CNTY_TYPE,DN_NO FROM SMRV WHERE DN_NO IN (" + relFilter + ") ";
