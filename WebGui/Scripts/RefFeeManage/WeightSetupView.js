    ...
    _handler.saveData = function (dtd) {
        ...
        $.each(allData, function (i, val) {
            if (typeof val.id != "undefined" && val.id != "") 
            {
                ...
                var FeeFrom = getGridVal($MainGrid, val.id, "FeeFrom", null);
                var FeeTo = getGridVal($MainGrid, val.id, "FeeTo", null);
...
function genMainGrid() {
    var colModelSetting = [
        ...
        { name: 'FeeFrom', editable: true, hidden: false, width: 100, order: 3 },
        { name: 'FeeTo', editable: true, hidden: false, width: 100, order: 4 },
        ...
        { name: 'FeeWeight',hidden: true },
        { name: 'FeeOp',hidden: true },
