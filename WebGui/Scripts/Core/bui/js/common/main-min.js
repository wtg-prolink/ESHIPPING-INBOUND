...
define('common/main', ['bui/menu', 'bui/tab'], function (require) {
    ...
    function getNavPositionSetting() {
        ...
        if (splitIndex >= 0) {
            moduleIndex = decodeURIComponent(pos.substring(1, splitIndex));
    ...
    BUI.augment(mainPage, {
        ...
        closePage: function (id, moduleId) {
            //var r = confirm("Confirm close this page?");
            //if (r == true) {
        ...
        _initLocation: function () {
            ...
            if (defaultSetting) {
                ...
                _self._setPageSelected(index, pageId, false, search);
            } else {
        ...
        _setPageSelected: function (moduleIndex, pageId, isReload, search, url) {
            var _self = this,
