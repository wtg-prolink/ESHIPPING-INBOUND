...
$.fn.jqGrid = function( pin ) {
    ...
    return this.each( function() {
        ...
        dir = ts.p.direction;
        this.p.loadtext = '<div class="spinner">\
        ...
        $("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"'>"+this.p.loadtext+"</div>").insertBefore(gv).css("border", "0");
...
$.jgrid.extend({
    ...
    columnChooser : function(opts) {
        ...
        opts = $.extend({
            ...
            "msel_opts": {},
            "modal_diag": function (d) {
                if (!$("#colchooser_" + $.jgrid.jqID(self[0].p.id)).length) { return; }

                var diag_class = $("div[aria-describedby='colchooser_" + self[0].p.id + "']>div[class*='ui-dialog-titlebar']>button[class*='ui-dialog-titlebar-diag']>span").attr('class');
                var altura = $(window).height() - 100;
                var modalWidth = $(window).width() - 100;
                if (modalWidth < 470 || altura < 370)
                    return;
                if (diag_class.indexOf("ui-icon-arrow-4-diag") > -1) {
                    $("div[aria-describedby='colchooser_" + self[0].p.id + "']").css({ "height": altura });
                    $("div[aria-describedby='colchooser_" + self[0].p.id + "']").css({ "width": modalWidth });
                    $("div[aria-describedby='colchooser_" + self[0].p.id + "']").css("top", ($(window).height() - altura) / 2 + $(window).scrollTop() + "px");
                    $("div[aria-describedby='colchooser_" + self[0].p.id + "']").css("left", ($(window).width() - modalWidth) / 2 + $(window).scrollLeft() + "px");
                    $("#colchooser_" + self[0].p.id + ">div").css('margin', '');
                    $('#colchooser_' + self[0].p.id + '>div').css('height', altura - 150);
                    $('#colchooser_' + self[0].p.id + '>div').css('width', modalWidth - 50);
                    $('#colchooser_' + self[0].p.id + '>div>div').css('width', modalWidth - 50);
                    $('#colchooser_' + self[0].p.id + '>div>div>div[class="selected"]').css('width', (modalWidth - 50) * 0.6);
                    $('#colchooser_' + self[0].p.id + '>div>div>div[class="available"]').css('width', modalWidth - (modalWidth - 50) * 0.6 - 53);
                    $('#colchooser_' + self[0].p.id + '>div>div>div[class="selected"]>ul').css('height', altura - 180);
                    $('#colchooser_' + self[0].p.id + '>div>div>div[class="available"]>ul').css('height', altura - 180);
                    $("div[aria-describedby='colchooser_" + self[0].p.id + "']>div[class*='ui-dialog-titlebar']>button[class*='ui-dialog-titlebar-diag']>span").removeClass("ui-icon-arrow-4-diag");
                    $("div[aria-describedby='colchooser_" + self[0].p.id + "']>div[class*='ui-dialog-titlebar']>button[class*='ui-dialog-titlebar-diag']>span").addClass("ui-icon-arrow-4");
                } else {
                    $("div[aria-describedby='colchooser_" + self[0].p.id + "']").css({ "height": "auto" });
                    $("div[aria-describedby='colchooser_" + self[0].p.id + "']").css({ "width": "470px" });
                    $("div[aria-describedby='colchooser_" + self[0].p.id + "']").css("top", ($(window).height() - 370) / 2 + $(window).scrollTop() + "px");
                    $("div[aria-describedby='colchooser_" + self[0].p.id + "']").css("left", ($(window).width() - 470) / 2 + $(window).scrollLeft() + "px");
                    $('#colchooser_' + self[0].p.id + '>div').css('height', "240px");
                    $('#colchooser_' + self[0].p.id + '>div').css('width', "420px");
                    $('#colchooser_' + self[0].p.id + '>div>div').css('width', "421px");
                    $('#colchooser_' + self[0].p.id + '>div>div>div[class="selected"]').css('width', "251px");
                    $('#colchooser_' + self[0].p.id + '>div>div>div[class="available"]').css('width', "167px");
                    $('#colchooser_' + self[0].p.id + '>div>div>div[class="selected"]>ul').css('height', "198.4px");
                    $('#colchooser_' + self[0].p.id + '>div>div>div[class="available"]>ul').css('height', "198.4px");
                    $("div[aria-describedby='colchooser_" + self[0].p.id + "']>div[class*='ui-dialog-titlebar']>button[class*='ui-dialog-titlebar-diag']>span").removeClass("ui-icon-arrow-4");
                    $("div[aria-describedby='colchooser_" + self[0].p.id + "']>div[class*='ui-dialog-titlebar']>button[class*='ui-dialog-titlebar-diag']>span").addClass("ui-icon-arrow-4-diag");
                }
            }
        }, $.jgrid.col, opts || {});
        if($.ui) {
