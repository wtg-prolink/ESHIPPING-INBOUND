...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        updateFileDetails: function (numFiles) {
            ...
            self.setCaption(log, self.isError, self.fileTypeError);
        ...
        setCaption: function (content, isError, fileTypeError) {
            var self = this, err = isError || false, title, out, typeError = fileTypeError || false;
            if (isEmpty(content) || self.$caption.length === 0) {
                return;
            }
            if (err) {
                var msgError = self.msgValidationError;
                if (typeError) {
                    msgError = self.msgFileTypeError;
                }
                title = $('<div>' + msgError + '</div>').text();
    ...
    $.fn.fileinput.locales.en = {
        ...
        msgFileTypeError: "This file type is not support to upload",
