...
function SetEtdEta() {
    ...
    $("#Etd5").change(function () {
        getChangeEdt();
    });
    $("#Etd6").change(function () {
        getChangeEdt();
    });
    $("#Etd7").change(function () {
        getChangeEdt();
    });
    ...
    $("#Eta5").change(function () {
        getChangeEda();
    });
    $("#Eta6").change(function () {
        getChangeEda();
    });
    $("#Eta7").change(function () {
        getChangeEda();
    });
}
...
function getChangeEdt() {
    ...
    else if (!isEmpty($("#Etd5").val())) {
        $("#Etd").val($("#Etd5").val());
    }
    else if (!isEmpty($("#Etd6").val())) {
        $("#Etd").val($("#Etd6").val());
    }
    else if (!isEmpty($("#Etd7").val())) {
        $("#Etd").val($("#Etd7").val());
    }
}
...
function getChangeEda() {
    ...
    else if (!isEmpty($("#Eta6").val())) {
        $("#Eta").val($("#Eta6").val());
    }
    else if (!isEmpty($("#Eta5").val())) {
        $("#Eta").val($("#Eta5").val());
    }
    else if (!isEmpty($("#Eta4").val())) {
        $("#Eta").val($("#Eta4").val());
    }
