...
$(function(){
	...
	_handler.saveData = function (dtd) {
	    var containerArray = $SubGrid2.jqGrid('getGridParam', "arrangeGrid")();
	    var changeData = getChangeValue();//获取所有改变的值
	    changeData["smidn"] = containerArray;
	    if (changeData["mt"]) {
	        changeData["mt"][0]["TranType"] = "E";
	    }
	...
	_handler.setFormData = function (data) {
		...
		MenuBarFuncArr.Enabled(["MBCopy", "MBEdoc","MBAllocation","MBConfirm"]);
