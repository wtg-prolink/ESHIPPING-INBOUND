...
function initQTGrid() {
        ...
        var chg_op = getLookupOp("MainGrid",
            {
                ...
                function ($grid, rd, elem, rowid) {
                    ...
                    return " TRAN_MODE@@L;O";
                }), {
            param: "",
            baseConditionFunc: function () {
                return "TRAN_MODE IN ('L','O')";
            }
        });
        return chg_op;
    }
    ...
    var colModel = [
        ...
        { name: 'PolCd', title: '@Resources.Locale.L_BaseLookup_PolCd', index: 'PolCd', editoptions: gridLookup(getcityop("PolCd")), edittype: 'custom', sorttype: 'string', width: 100, hidden: false, editable: true },
        { name: 'PolNm', title: 'PolNm', index: 'PolNm', sorttype: 'string', width: 140, editable: false, hidden: false },
        { name: 'ViaCd', title: 'Via', index: 'ViaCd', sorttype: 'string', width: 80, hidden: false, editable: true },
        { name: 'PodCd', title: '@Resources.Locale.L_BaseLookup_DestCd', index: 'PodCd', editoptions: gridLookup(getcityop("PodCd")), edittype: 'custom', sorttype: 'string', width: 100, hidden: false, editable: true },
        { name: 'PodNm', title: '@Resources.Locale.L_BaseLookup_DestName', index: 'PodNm', sorttype: 'string', width: 140, editable: false, hidden: false },
        ...
        { name: 'ChgCd', title: '@Resources.Locale.L_SMCHGSetup_ChgCd', index: 'ChgCd', sorttype: 'string', width: 90, hidden: false, editable: true, editoptions: gridLookup(getchg("ChgCd")), edittype: 'custom' },
        ...
        { name: 'ChgType', title: '@Resources.Locale.L_SMCHGSetup_ChgType', index: 'ChgType', sorttype: 'string', width: 90, hidden: false, editable: true, formatter: "select", editoptions: { value: 'F:F.Freight Charge;O:O.Original Fee;D:D.Destination Fee' }, edittype: 'select' },
        ...
        { name: 'Cur', title: '@Resources.Locale.L_IpPart_Crncy', index: 'Cur', editoptions: gridLookup(getcur("Cur")), edittype: 'custom', sorttype: 'string', width: 90, align: 'left', hidden: false, editable: true },
        { name: 'MinAmt', title: '@Resources.Locale.L_AirSetup_MinAmt', index: 'MinAmt', width: 80, align: 'right', formatter: 'number', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2, defaultValue: '0.00' }, hidden: false, editable: true },
        { name: 'F1', title: '@Resources.Locale.L_SLCLQuery_F1', index: 'F1', width: 80, align: 'right', formatter: 'number', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2, defaultValue: '0.00' }, hidden: false, editable: true },
        { name: 'CutOff', title: 'Cut Off', index: 'CutOff', width: 100, align: 'left', sorttype: 'string', hidden: false, editable: true },
        { name: 'Etd', title: 'ETD', index: 'Etd', width: 100, align: 'left', sorttype: 'string', hidden: false, editable: true },
    ...
    _handler.intiGrid("MainGrid", $MainGrid, {
        colModel: colModel, caption: 'LCL', delKey: ["UId"], height: 200,
        onAddRowFunc: function (rowid) {
            ...
            setDefutltGridData($MainGrid, rowid, { "PodCd": true, "PolCd": true, "Cur": true });
...
$(function () {
    ...
    _handler.beforSave = function () {
        ...
        //nullCols.push({ name: "Carrier", index: 11, text: 'Carrier' });
        nullCols.push({ name: "ChgType", index: 15, text: '@Resources.Locale.L_SMCHGSetup_ChgRepay' });
