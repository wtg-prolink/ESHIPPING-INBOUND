...
function DataSummary()
{
    ...
    gop.gridColModel = [
        ...
        { name: 'RvRemark', title: '@Resources.Locale.L_BSLCPOL_Remark', index: 'RvRemark', width: 80, align: 'left', sorttype: 'string', hidden: false },
        ...
        { name: 'DownDate', title: '@Resources.Locale.L_DNManage_DownDate', index: 'DownDate', width: 120, align: 'left', sorttype: 'date', hidden: false, formatter: 'date', formatoptions: { srcformat: "ISO8601Long", newformat: "Y-m-d H:i" } }
    ];
            ...
            $.post(rootPath+"GateManage/chkSmdnpCount", {}, function(data, textStatus, xhr) {
                if(data.msg == "success")
                {
                    ...
                    var colModel1 = [
                            ...
                            //{ name: 'RvRemark', title: '@Resources.Locale.L_BSLCPOL_Remark', index: 'RvRemark', width: 120, align: 'left', sorttype: 'string', hidden: false, caption: '@Resources.Locale.L_BSLCPOL_Remark' }
                        ];
                    var conditions = "";
...
$(function () {
    ...
    var colModel = [
        ...
        { name: 'MoveNumber', title: '@Resources.Locale.L_GateAnalysis_TotalMoveNumber', index: 'MoveNumber', width: 70, align: 'right', sorttype: 'float', hidden: false },
