...
function gridSetup()
{
    ...
    colModel2 = [
	    ...
	    { name: 'Status', title: '@Resources.Locale.L_GateReserve_Status', index: 'Status', width: 80, sorttype: 'string', hidden: false, editable: true, formatter: "select", edittype: 'select', editoptions: { value: '@Resources.Locale.L_FCLChgSetup_Script_166', dataInit: function (elem) { $(elem).addClass('form-control input-sm'); } } },
