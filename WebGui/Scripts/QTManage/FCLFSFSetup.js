...
function initQTGrid() {
    ...
    var colModel = [
        ...
        { name: 'PodCd', title: '@Resources.Locale.L_BaseLookup_PodCd', index: 'PodCd', sorttype: 'string', edittype: 'custom', editoptions: gridLookup(get_cityop("PodCd")), width: 80, hidden: false, editable: true },
...
$(function () {
    ...
    _handler.beforSave = function () {
        ...
        //nullCols.push({ name: "Carrier", index: 13, text: 'Carrier' });
        //nullCols.push({ name: "Incoterm", index: 14, text: 'Service Mode' });
