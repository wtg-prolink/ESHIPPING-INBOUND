...
function initQTGrid() {
    ...
    var colModel = [
       ...
       { name: 'Carrier', title: '@Resources.Locale.L_QTSetup_Carrier', index: 'Carrier', width: 100, align: 'left', sorttype: 'string', hidden: false, editable: true, formatter: "select", editoptions: { value: _selectWH }, edittype: 'select' },
    ...
    _handler.intiGrid("MainGrid", $MainGrid, {
        colModel: colModel, caption: '@Resources.Locale.L_QuotBrokerSetup_Scripts_312', delKey: ["UId"], height: 300,
...
$(function () {
    ...
    _handler.addData = function () {
        ...
        if (ioflag == "O") {
            $("#LspCd").attr('disabled');
            $("#LspCdLookup").attr('disabled');
        }
        var data = { "TranMode": "B", "TranType": "F", QuotType: "P", "Period": "B", "OutIn": "O", "FreightTerm": "PP", LspCd: cmp, "EffectFrom": getDate(0, "-"), "EffectTo": getDate(365, "-") };
    ...
    _handler.beforSave = function () {
        ...
        nullCols.push({ name: "ChgCd", index: 7, text: '@Resources.Locale.L_SMCHGSetup_ChgCd' });
        nullCols.push({ name: "ChgType", index: 9, text: '@Resources.Locale.L_SMCHGSetup_ChgType' });
        nullCols.push({ name: "Punit", index: 12, text: '@Resources.Locale.L_AirQuery_Punit' });
        nullCols.push({ name: "Cur", index: 13, text: '@Resources.Locale.L_IpPart_Crncy' });
