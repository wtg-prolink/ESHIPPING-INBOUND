function btnGroup() {
    MenuBarFuncArr.AddMenu("btn03", "glyphicon glyphicon-log-out", "@Resources.Locale.L_ActManage_Pass", function () {
    ...
    MenuBarFuncArr.AddMenu("btn04", "glyphicon glyphicon-log-out", "@Resources.Locale.L_ActManage_Back", function () {
        $("#BackRemark").val("");
        var uid = $("#UId").val();
        if (!uid) {
    ...
    MenuBarFuncArr.AddMenu("btn06", "glyphicon glyphicon-log-out", "@Resources.Locale.L_ActManage_ApDetail", function () {
        CheckDetailed();
    });
}
