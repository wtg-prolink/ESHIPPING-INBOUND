...
function initQTGrid() {
    ...
    var colModel = [
      ...
      { name: 'PodCd', title: '@Resources.Locale.L_BaseLookup_PodCd', index: 'PodCd', editoptions: gridLookup(getcityop("PodCd")), edittype: 'custom', sorttype: 'string', width: 100, hidden: false, editable: true },
      { name: 'PodNm', title: 'PodNm', index: 'PodNm', sorttype: 'string', width: 140, editable: false, hidden: false },
